          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
            ...
            <div className="lg:col-span-4">
              ...
              <div className="flex space-x-5">
                <a href="https://facebook.com/hunterclub.strelnica" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-[var(--color-safety)] hover:text-white hover:border-[var(--color-safety)] transition-all duration-300">
                ...
                <a href="https://instagram.com/hunterclub.strelnica" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-[var(--color-safety)] hover:text-white hover:border-[var(--color-safety)] transition-all duration-300">
                ...
                <a href="https://www.tiktok.com/@hunterclub.strelnica" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-[var(--color-safety)] hover:text-white hover:border-[var(--color-safety)] transition-all duration-300">
